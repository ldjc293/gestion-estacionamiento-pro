...
$breadcrumb = [
    ...
    ['label' => 'Controles', 'url' => url('admin/controles')],
    ['label' => 'Asignar', 'url' => '#']
];
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= url('admin/controles/asignar/process') ?>" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="apartamento_usuario_id" id="apartamento_usuario_id" class="form-select" required>
                                    ...
                                    <?php foreach ($apartamentosUsuarios as $au): ?>
                                        <?php 
                                            // Calcular cupo disponible (esto es aproximado, idealmente vendría del controlador)
                                            // Pero para mostrar opciones válidas sirve
                                        ?>
                                        <option value="<?= $au['id'] ?>">
                            ...
                            <div class="d-flex justify-content-between">
                                <a href="<?= url('admin/controles') ?>" class="btn btn-secondary">Cancelar</a>
