    ...
    Swal.fire({
                    ...
                    <div class="tab-pane fade show active" id="tab-cargar-con" role="tabpanel">
                        ...
                        <div class="row g-2">
                            <div class="col-6">
                                ...
                                <select id="swalAnioFinCon" class="form-select form-select-sm"><option value="">Hasta la fecha actual (${anioActual})</option>${opcionesAnio}</select>
                            </div>
                            <div class="col-6">
                                <label class="form-label font-semibold small mb-1">Mes Fin (Opcional):</label>
                                <select id="swalMesFinCon" class="form-select form-select-sm"><option value="">Hasta el mes actual</option>${opcionesMes}</select>
                            </div>
                        </div>
                    </div>
                    <!-- Tab Revertir -->
        ...
        preConfirm: () => {
            ...
            if (isRevertir) {
                ...
                const anioFin = document.getElementById('swalAnioFinCon').value;
                const mesFin = document.getElementById('swalMesFinCon').value;
                if (!anio || !mes) {
