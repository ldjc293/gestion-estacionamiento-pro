        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="<?= url('consultor/update-perfil') ?>" method="POST">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="<?= url('consultor/cambiar-password') ?>" class="btn btn-outline-primary">
            ...
            <div class="col-md-4">
                ...
                <div class="card mb-4 text-center">
                    <div class="card-body">
                        ...
                        ?>
                        <div class="mx-auto mb-3" style="width: 120px; height: 120px; border-radius: 50%; background: linear-gradient(135deg, #06b6d4, #0891b2); color: white; display: flex; align-items: center; justify-content: center; font-size: 48px; font-weight: 600;">
                            <?= $initials ?>
                        </div>
                        <h5><?= htmlspecialchars($usuario->nombre_completo) ?></h5>
                        <p class="text-muted mb-0"><?= htmlspecialchars($usuario->email) ?></p>
                        <span class="badge bg-info mt-2">consultor</span>
                    </div>
                </div>
